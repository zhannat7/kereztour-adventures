  ...
  return (
    <section className="py-16 md:py-24 bg-background">
      <div ref={ref} className="section-reveal container mx-auto px-6 max-w-[1600px]">
        ...
        <div className="mx-auto mt-8 max-w-[780px] overflow-hidden rounded-[1.75rem] shadow-lift">
        ...
        <p className="mx-auto mt-4 max-w-[780px] text-right text-xs text-muted-foreground">
