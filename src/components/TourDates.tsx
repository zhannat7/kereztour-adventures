...
const TourDates = () => {
  ...
  return (
    <div className="relative z-20 mx-auto -mt-16 flex w-full max-w-[1600px] justify-end px-6 sm:-mt-20 lg:px-16 xl:px-24">
      <div className="relative mr-2 flex h-[200px] w-[200px] flex-col items-center justify-center rounded-full border border-gold/40 bg-card/70 px-6 text-center shadow-lift backdrop-blur-md sm:mr-6 lg:mr-12">
